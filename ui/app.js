...
(function(exports) {
  ...
  var decodeJsonResponse = function (dictDecodeJson) {
      return function ($116) {
          return Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Data_Identity.applicativeIdentity)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(function ($117) {
              return Control_Applicative.pure(Data_List_Types.applicativeNonEmptyList)(Data_Foreign.ForeignError.create($117));
          })(Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson)($116))));
      };
  };
  ...
  var responsableJsonIntent = new Network_HTTP_Affjax_Response.Respondable(Control_Bind.composeKleisliFlipped(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(decodeJsonResponse(decodeJsonIntent))(Network_HTTP_Affjax_Response.fromResponse(Network_HTTP_Affjax_Response.responsableJson)), new Data_Tuple.Tuple(new Data_Maybe.Just(Data_MediaType_Common.textPlain), Network_HTTP_Affjax_Response.JSONResponse.value));
  ...
  var responsableJsonHash = new Network_HTTP_Affjax_Response.Respondable(Control_Bind.composeKleisliFlipped(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(decodeJsonResponse(decodeJsonHash))(Network_HTTP_Affjax_Response.fromResponse(Network_HTTP_Affjax_Response.responsableJson)), new Data_Tuple.Tuple(new Data_Maybe.Just(Data_MediaType_Common.textPlain), Network_HTTP_Affjax_Response.JSONResponse.value));
  var intentCreate = function (intent) {
      return Network_HTTP_Affjax.post(Network_HTTP_Affjax_Request.requestableJson)(responsableJsonHash)("http://localhost:4141/fn/Intents/intentCreate")(Data_Argonaut_Encode_Class.encodeJson(encodeJsonIntent)(intent));
  };
  var ui = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(Halogen_HTML_Events.input(function (e) {
              ...
              if (st.retrievedIntent instanceof Data_Maybe.Nothing) {
                  return [ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Read: Nothing") ]) ];
              };
              if (st.retrievedIntent instanceof Data_Maybe.Just) {
                  return [ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Read:") ]), Halogen_HTML_Elements.pre_([ Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text(Data_Show.show(showIntent)(st.retrievedIntent.value0)) ]) ]) ];
              };
              throw new Error("Failed pattern match at Component line 125, column 13 - line 136, column 18: " + [ st.retrievedIntent.constructor.name ]);
          })()), Halogen_HTML_Elements.div_((function () {
              ...
              throw new Error("Failed pattern match at Component line 138, column 13 - line 145, column 18: " + [ st.result.constructor.name ]);
          })()) ]) ]);
      };
      var initialState = {
          loading: false,
      ...
      var $$eval = function (v) {
          if (v instanceof SetUsername) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $71.username = v.value0;
                  $71.result = Data_Maybe.Nothing.value;
                  return $71;
              }))(function () {
          ...
          if (v instanceof SetIntentText) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $76.intentText = v.value0;
                  $76.result = Data_Maybe.Nothing.value;
                  return $76;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v instanceof SetIntentType) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $81.intentType = v.value0;
                  $81.result = Data_Maybe.Nothing.value;
                  return $81;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v instanceof SetCreatedHash) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $86.createdHash = new Data_Maybe.Just(new Hash(v.value0));
                  $86.result = Data_Maybe.Nothing.value;
                  return $86;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(intentCreate(intent)))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $96.loading = false;
                              $96.createdHash = new Data_Maybe.Just(v2.response);
                              $96.result = new Data_Maybe.Just(getHash(v2.response));
                              return $96;
                          }))(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(intentRead(v1.value0)))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $106.loading = false;
                                  $106.retrievedIntent = new Data_Maybe.Just(v2.response);
                                  $106.result = new Data_Maybe.Just("got hash result:" + Data_Show.show(Network_HTTP_StatusCode.showStatusCode)(v2.status));
                                  return $106;
                              }))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                              });
                  ...
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $110.loading = false;
                          $110.result = new Data_Maybe.Just("no hash value");
                          return $110;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  };
                  throw new Error("Failed pattern match at Component line 180, column 7 - line 193, column 20: " + [ v1.constructor.name ]);
              });
          };
          ...
          throw new Error("Failed pattern match at Component line 150, column 10 - line 200, column 17: " + [ v.constructor.name ]);
      };
