...
(function(exports) {
  ...
  var Network_HTTP_StatusCode = PS["Network.HTTP.StatusCode"];
  var Prelude = PS["Prelude"];        
  var SetIntentText = (function () {
      function SetIntentText(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetIntentText.create = function (value0) {
          return function (value1) {
              return new SetIntentText(value0, value1);
          };
      };
      return SetIntentText;
  })();
  var SetIntentType = (function () {
      function SetIntentType(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetIntentType.create = function (value0) {
          return function (value1) {
              return new SetIntentType(value0, value1);
          };
      };
      return SetIntentType;
  })();
  var SetCreatedHash = (function () {
      function SetCreatedHash(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetCreatedHash.create = function (value0) {
          return function (value1) {
              return new SetCreatedHash(value0, value1);
          };
      };
      return SetCreatedHash;
  })();
  var MakeRequestCreate = (function () {
      function MakeRequestCreate(value0) {
          this.value0 = value0;
      };
      MakeRequestCreate.create = function (value0) {
          return new MakeRequestCreate(value0);
      };
      return MakeRequestCreate;
  })();
  var MakeRequestRetrieve = (function () {
      function MakeRequestRetrieve(value0) {
          this.value0 = value0;
      };
      MakeRequestRetrieve.create = function (value0) {
          return new MakeRequestRetrieve(value0);
      };
      return MakeRequestRetrieve;
  })();
  var MakeRequestGetAll = (function () {
      function MakeRequestGetAll(value0) {
          this.value0 = value0;
      };
      MakeRequestGetAll.create = function (value0) {
          return new MakeRequestGetAll(value0);
      };
      return MakeRequestGetAll;
  })();
  ...
  var Intent = (function () {
      function Intent(value0) {
          this.value0 = value0;
      };
      Intent.create = function (value0) {
          return new Intent(value0);
      };
      return Intent;
  })();
  var Hash = (function () {
      function Hash(value0) {
          this.value0 = value0;
      };
      Hash.create = function (value0) {
          return new Hash(value0);
      };
      return Hash;
  })();
  var HoloEntry = (function () {
      function HoloEntry(value0) {
          this.value0 = value0;
      };
      HoloEntry.create = function (value0) {
          return new HoloEntry(value0);
      };
      return HoloEntry;
  })();
  var HoloEntryArray = (function () {
      function HoloEntryArray(value0) {
          this.value0 = value0;
      };
      HoloEntryArray.create = function (value0) {
          return new HoloEntryArray(value0);
      };
      return HoloEntryArray;
  })();
  var getHoloEntries = function (v) {
      return v.value0;
  };
  var getHash = function (v) {
      return v.value0;
  };
  var genericIntent = new Data_Generic.Generic(function (v) {
      if (v instanceof Data_Generic.SProd && (v.value0 === "Component.Intent" && v.value1.length === 1)) {
          return Control_Apply.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(Intent.create))((function (r) {
              if (r instanceof Data_Generic.SRecord && r.value0.length === 3) {
                  return Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(function (content1) {
                      return function (timestamp1) {
                          return function (typ1) {
                              return {
                                  content: content1,
      ...
      return new Data_Generic.SigProd("Component.Intent", [ {
          sigConstructor: "Component.Intent",
      ...
      return new Data_Generic.SProd("Component.Intent", [ function ($dollarq) {
          return new Data_Generic.SRecord([ {
              recLabel: "content",
              recValue: function ($dollarq1) {
                  return Data_Generic.toSpine(Data_Generic.genericString)(v.value0.content);
              }
          }, {
              recLabel: "timestamp",
              recValue: function ($dollarq1) {
                  return Data_Generic.toSpine(Data_Generic.genericString)(v.value0.timestamp);
              }
          }, {
              recLabel: "typ",
              recValue: function ($dollarq1) {
                  return Data_Generic.toSpine(Data_Generic.genericString)(v.value0.typ);
              }
          } ]);
      } ]);
  });                                                                              
  var showIntent = new Data_Show.Show(Data_Generic.gShow(genericIntent));
  var encodeJsonIntent = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      return Data_Argonaut_Encode_Combinators.extend(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Argonaut_Encode_Combinators.assoc(Data_Argonaut_Encode_Class.encodeJsonJString)("content")(v.value0.content))(Data_Argonaut_Encode_Combinators.extend(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Argonaut_Encode_Combinators.assoc(Data_Argonaut_Encode_Class.encodeJsonJString)("type")(v.value0.typ))(Data_Argonaut_Encode_Combinators.extend(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Argonaut_Encode_Combinators.assoc(Data_Argonaut_Encode_Class.encodeJsonJString)("timestamp")(v.value0.timestamp))(Data_Argonaut_Core.jsonEmptyObject)));
  });
  var decodeJsonResponse = function (dictDecodeJson) {
      return function ($205) {
          return Control_Monad_Except_Trans.ExceptT(Control_Applicative.pure(Data_Identity.applicativeIdentity)(Data_Bifunctor.lmap(Data_Either.bifunctorEither)(function ($206) {
              return Control_Applicative.pure(Data_List_Types.applicativeNonEmptyList)(Data_Foreign.ForeignError.create($206));
          })(Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson)($205))));
      };
  };
  var decodeJsonIntent = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("content"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("type"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("timestamp"))(function (v3) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(new Intent({
                          content: v1,
                          typ: v2,
                          timestamp: v3
                      }));
  ...
  var responsableJsonIntent = new Network_HTTP_Affjax_Response.Respondable(Control_Bind.composeKleisliFlipped(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(decodeJsonResponse(decodeJsonIntent))(Network_HTTP_Affjax_Response.fromResponse(Network_HTTP_Affjax_Response.responsableJson)), new Data_Tuple.Tuple(new Data_Maybe.Just(Data_MediaType_Common.applicationJSON), Network_HTTP_Affjax_Response.JSONResponse.value));
  var intentRead = function (v) {
      return Network_HTTP_Affjax.post(Network_HTTP_Affjax_Request.requestableJson)(responsableJsonIntent)("/fn/Intents/intentRead")(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(v.value0));
  };
  var decodeJsonHoloEntryArray = function (dictDecodeJson) {
      return new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeArray(dictDecodeJson))(json))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)(new HoloEntryArray(v));
          });
      });
  };
  var responsableJsonHoloEntryArray = function (dictDecodeJson) {
      return new Network_HTTP_Affjax_Response.Respondable(Control_Bind.composeKleisliFlipped(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(decodeJsonResponse(decodeJsonHoloEntryArray(dictDecodeJson)))(Network_HTTP_Affjax_Response.fromResponse(Network_HTTP_Affjax_Response.responsableJson)), new Data_Tuple.Tuple(new Data_Maybe.Just(Data_MediaType_Common.applicationJSON), Network_HTTP_Affjax_Response.JSONResponse.value));
  };
  var decodeJsonHash = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeJsonString)(json))(function (v) {
          return Control_Applicative.pure(Data_Either.applicativeEither)(new Hash(v));
      });
  });
  var decodeJsonHoloEntry = function (dictDecodeJson) {
      return new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(dictDecodeJson)(v)("Entry"))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("EntryType"))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonHash)(v)("Hash"))(function (v3) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonHash)(v)("Source"))(function (v4) {
                              return Control_Applicative.pure(Data_Either.applicativeEither)(new HoloEntry({
                                  entry: v1,
                                  entryType: v2,
                                  entryHash: v3,
                                  entrySource: v4
  ...
  var getAllIntents = Network_HTTP_Affjax.post(Network_HTTP_Affjax_Request.requestableString)(responsableJsonHoloEntryArray(decodeJsonHoloEntry(decodeJsonIntent)))("/fn/Intents/getAllIntents")("");
  var responsableJsonHash = new Network_HTTP_Affjax_Response.Respondable(Control_Bind.composeKleisliFlipped(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(decodeJsonResponse(decodeJsonHash))(Network_HTTP_Affjax_Response.fromResponse(Network_HTTP_Affjax_Response.responsableJson)), new Data_Tuple.Tuple(new Data_Maybe.Just(Data_MediaType_Common.applicationJSON), Network_HTTP_Affjax_Response.JSONResponse.value));
  var intentCreate = function (intent) {
      return Network_HTTP_Affjax.post(Network_HTTP_Affjax_Request.requestableJson)(responsableJsonHash)("/fn/Intents/intentCreate")(Data_Argonaut_Encode_Class.encodeJson(encodeJsonIntent)(intent));
  };
  var ui = (function () {
      var renderIntent = function (v) {
          return Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(v.value0.content) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(v.value0.typ) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(v.value0.timestamp) ]) ]);
      };
      var renderHoloEntryIntent = function (v) {
          return renderIntent(v.value0.entry);
      };
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(Halogen_HTML_Events.input(function (e) {
              return function (a) {
                  return new PreventDefault(e, new MakeRequestCreate(a));
              };
          })) ])([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Post an intent") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("This will be stored in Holochain and the hash key for the new intent will be shown") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("in the Hash text box below.") ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Intent:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.intentText), Halogen_HTML_Properties.attr("size")("50"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetIntentText.create)) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.intentType), Halogen_HTML_Properties.attr("size")("50"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetIntentType.create)) ]) ]), Halogen_HTML_Elements.p_([  ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputSubmit.value), Halogen_HTML_Properties.value("Submit"), Halogen_HTML_Properties.disabled(st.loading) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
              if (st.loading) {
                  return "Working...";
              };
              return "";
          })()) ]) ]), Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(Halogen_HTML_Events.input(function (e) {
              return function (a) {
                  return new PreventDefault(e, new MakeRequestRetrieve(a));
              };
          })) ])([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Retrieve an intent") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Press the Read button and the hash key will be used to retrieve the intent") ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Hash:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(Data_Maybe.maybe("")(getHash)(st.createdHash)), Halogen_HTML_Properties.attr("size")("50"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetCreatedHash.create)) ]) ]), Halogen_HTML_Elements.p_([  ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputSubmit.value), Halogen_HTML_Properties.value("Read"), Halogen_HTML_Properties.disabled(st.loading) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
              if (st.loading) {
                  return "Working...";
              };
              return "";
          })()) ]), Halogen_HTML_Elements.div_((function () {
              if (st.retrievedIntent instanceof Data_Maybe.Nothing) {
                  return [  ];
              };
              if (st.retrievedIntent instanceof Data_Maybe.Just) {
                  return [ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Read:") ]), Halogen_HTML_Elements.pre_([ Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text(Data_Show.show(showIntent)(st.retrievedIntent.value0)) ]) ]) ];
              };
              throw new Error("Failed pattern match at Component line 140, column 13 - line 147, column 18: " + [ st.retrievedIntent.constructor.name ]);
          })()), Halogen_HTML_Elements.div_((function () {
              if (st.result instanceof Data_Maybe.Nothing) {
                  return [  ];
              };
              if (st.result instanceof Data_Maybe.Just) {
                  return [ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Response:") ]), Halogen_HTML_Elements.pre_([ Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text(st.result.value0) ]) ]) ];
              };
              throw new Error("Failed pattern match at Component line 149, column 13 - line 156, column 18: " + [ st.result.constructor.name ]);
          })()) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(MakeRequestGetAll.create)) ])([ Halogen_HTML_Core.text("get all intents") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("All intents"), Halogen_HTML_Elements.table_(Data_Functor.map(Data_Functor.functorArray)(renderHoloEntryIntent)(getHoloEntries(st.allIntents))) ]) ]);
      };
      var initialState = {
          loading: false,
          intentText: "This text will be saved in Holochain",
          intentType: "Offer",
          createdHash: Data_Maybe.Nothing.value,
          retrievedIntent: Data_Maybe.Nothing.value,
          allIntents: new HoloEntryArray([  ]),
          result: Data_Maybe.Nothing.value
      };
      var $$eval = function (v) {
          if (v instanceof SetIntentText) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $160.intentText = v.value0;
                  $160.result = Data_Maybe.Nothing.value;
                  return $160;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof SetIntentType) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $165 = {};
                  for (var $166 in v1) {
                  ...
                  $165.intentType = v.value0;
                  $165.result = Data_Maybe.Nothing.value;
                  return $165;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof SetCreatedHash) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $170 = {};
                  for (var $171 in v1) {
                  ...
                  $170.createdHash = new Data_Maybe.Just(new Hash(v.value0));
                  $170.result = Data_Maybe.Nothing.value;
                  return $170;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof MakeRequestCreate) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      var intent = new Intent({
                          content: v1.intentText,
                          typ: v1.intentType,
                          timestamp: "1525534245"
                      });
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(intentCreate(intent)))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $180 = {};
                              for (var $181 in v3) {
                                  if ({}.hasOwnProperty.call(v3, $181)) {
                                      $180[$181] = v3[$181];
                                  };
                              };
                              $180.loading = false;
                              $180.createdHash = new Data_Maybe.Just(v2.response);
                              $180.result = new Data_Maybe.Just(getHash(v2.response));
                              return $180;
                          }))(function () {
          ...
          if (v instanceof MakeRequestRetrieve) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.createdHash;
              }))(function (v1) {
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          var $186 = {};
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(intentRead(v1.value0)))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $190 = {};
                                  for (var $191 in v3) {
                                  ...
                                  $190.loading = false;
                                  $190.retrievedIntent = new Data_Maybe.Just(v2.response);
                                  $190.result = new Data_Maybe.Just("got hash result:" + Data_Show.show(Network_HTTP_StatusCode.showStatusCode)(v2.status));
                                  return $190;
                              }))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                              });
                  ...
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          var $194 = {};
                          for (var $195 in v2) {
                              if ({}.hasOwnProperty.call(v2, $195)) {
                                  $194[$195] = v2[$195];
                              };
                          };
                          $194.loading = false;
                          $194.result = new Data_Maybe.Just("no hash value");
                          return $194;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  };
                  throw new Error("Failed pattern match at Component line 204, column 7 - line 217, column 20: " + [ v1.constructor.name ]);
              });
          };
          if (v instanceof MakeRequestGetAll) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(getAllIntents))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      var $199 = {};
                      for (var $200 in v2) {
                          if ({}.hasOwnProperty.call(v2, $200)) {
                              $199[$200] = v2[$200];
                          };
                      };
                      $199.loading = false;
                      $199.allIntents = v1.response;
                      $199.result = new Data_Maybe.Just("getAllIntents result:" + Data_Show.show(Network_HTTP_StatusCode.showStatusCode)(v1.status));
                      return $199;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          if (v instanceof PreventDefault) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_Event_Event.preventDefault(v.value0)))(function () {
                  return $$eval(v.value1);
              });
          };
          throw new Error("Failed pattern match at Component line 177, column 10 - line 229, column 17: " + [ v.constructor.name ]);
      };
  ...
  exports["HoloEntryArray"] = HoloEntryArray;
  exports["HoloEntry"] = HoloEntry;
  exports["SetIntentText"] = SetIntentText;
  exports["SetIntentType"] = SetIntentType;
  exports["SetCreatedHash"] = SetCreatedHash;
  exports["MakeRequestCreate"] = MakeRequestCreate;
  exports["MakeRequestRetrieve"] = MakeRequestRetrieve;
  exports["MakeRequestGetAll"] = MakeRequestGetAll;
  exports["PreventDefault"] = PreventDefault;
  exports["ui"] = ui;
  exports["decodeJsonHash"] = decodeJsonHash;
  exports["genericIntent"] = genericIntent;
  exports["showIntent"] = showIntent;
  exports["decodeJsonIntent"] = decodeJsonIntent;
  exports["encodeJsonIntent"] = encodeJsonIntent;
  exports["decodeJsonHoloEntryArray"] = decodeJsonHoloEntryArray;
  exports["decodeJsonHoloEntry"] = decodeJsonHoloEntry;
  exports["responsableJsonIntent"] = responsableJsonIntent;
  exports["responsableJsonHash"] = responsableJsonHash;
  exports["responsableJsonHoloEntryArray"] = responsableJsonHoloEntryArray;
