...
(function(exports) {
  ...
  var getAllIntents = function (dictRespondable) {
      return Network_HTTP_Affjax.post(Network_HTTP_Affjax_Request.requestableString)(dictRespondable)("/fn/Intents/getAllIntents")("");
  };
  var encodeJsonIntent = new Data_Argonaut_Encode_Class.EncodeJson(function (v) {
      return Data_Argonaut_Encode_Combinators.extend(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Argonaut_Encode_Combinators.assoc(Data_Argonaut_Encode_Class.encodeJsonJString)("content")(v.value0.content))(Data_Argonaut_Encode_Combinators.extend(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Argonaut_Encode_Combinators.assoc(Data_Argonaut_Encode_Class.encodeJsonJString)("type")(v.value0.typ))(Data_Argonaut_Encode_Combinators.extend(Data_Argonaut_Encode_Class.encodeJsonJson)(Data_Argonaut_Encode_Combinators.assoc(Data_Argonaut_Encode_Class.encodeJsonInt)("timestamp")(v.value0.timestamp))(Data_Argonaut_Core.jsonEmptyObject)));
  });
  var intentCreate = (function () {
      var intent = new Intent({
          content: "Intent Content",
          typ: "Offer",
          timestamp: 1525534245
      });
      return Network_HTTP_Affjax.post(Network_HTTP_Affjax_Request.requestableJson)(Network_HTTP_Affjax_Response.responsableString)("http://localhost:4141/fn/Intents/intentCreate")(Data_Argonaut_Encode_Class.encodeJson(encodeJsonIntent)(intent));
  })();
  var ui = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(Halogen_HTML_Events.input(function (e) {
              return function (a) {
                  return new PreventDefault(e, new MakeRequest(a));
              };
          })) ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Lookup GitHub user") ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Enter username:") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(st.username), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(SetUsername.create)) ]) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputSubmit.value), Halogen_HTML_Properties.value("Fetch info"), Halogen_HTML_Properties.disabled(st.loading) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
              if (st.loading) {
                  return "Working...";
              };
              return "";
              ...
              throw new Error("Failed pattern match at Component line 60, column 11 - line 67, column 16: " + [ st.result.constructor.name ]);
          })()) ]);
      };
      var initialState = {
          loading: false,
      ...
      var $$eval = function (v) {
          if (v instanceof SetUsername) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $20.username = v.value0;
                  $20.result = Data_Maybe.Nothing.value;
                  return $20;
              }))(function () {
          ...
          if (v instanceof MakeRequest) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(intentCreate))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(getAllIntents(Network_HTTP_Affjax_Response.responsableString)))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                  ...
                                  $31.loading = false;
                                  $31.result = new Data_Maybe.Just(v3.response);
                                  return $31;
                              }))(function () {
          ...
          throw new Error("Failed pattern match at Component line 71, column 10 - line 90, column 17: " + [ v.constructor.name ]);
      };
