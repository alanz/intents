...
(function(exports) {
  ...
  var intentCreate = function (dictRespondable) {
      return Network_HTTP_Affjax.post(Network_HTTP_Affjax_Request.requestableString)(dictRespondable)("http://localhost:4141/fn/Intents/intentCreate")("{'content': 'task', 'type': 'typ', 'timestamp': '20180505'}");
  };
  ...
  var ui = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(Halogen_HTML_Events.input(function (e) {
              ...
              throw new Error("Failed pattern match at Component line 59, column 11 - line 66, column 16: " + [ st.result.constructor.name ]);
          })()) ]);
      };
      var initialState = {
          loading: false,
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof MakeRequest) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(intentCreate(Network_HTTP_Affjax_Response.responsableString)))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(getAllIntents(Network_HTTP_Affjax_Response.responsableString)))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                  ...
                                  $25.loading = false;
                                  $25.result = new Data_Maybe.Just(v3.response);
                                  return $25;
                              }))(function () {
          ...
          throw new Error("Failed pattern match at Component line 70, column 10 - line 86, column 17: " + [ v.constructor.name ]);
      };
